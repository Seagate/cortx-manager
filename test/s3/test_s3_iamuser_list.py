...
permissions = {"s3iamusers": {"list": True, "delete": True, "create": True}}
accounts_command = CommandFactory.get_command(["s3iamuser", 'show'], permissions)
t = unittest.TestCase()
...
def test_2():
    expected_output = EXPECTED_OUTPUT.get("iamuser", {}).get("show_test_2", {})
