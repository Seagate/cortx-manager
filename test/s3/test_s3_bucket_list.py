...
permissions = {"s3buckets": {"list": True, "update": True, "delete": True, "create": True}}
accounts_command = CommandFactory.get_command(["s3bucket", 'show'], permissions)
t = unittest.TestCase()
file_path = Const.MOCK_PATH

with open(os.path.dirname(f"{file_path}s3_bucket_commands_output.json")) as fp:
