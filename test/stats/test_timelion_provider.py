...
def test1(args):
    ...
    try:
        ...
        to_t = int(time.time())
        from_t = to_t - 30
        req_param = {"stats_id": 1, "panel": "", "from_t": from_t, "to_t": to_t, "metric_list": "",
                     "interval": 10, "total_sample": "", "unit": "", "output_format": "gui",
                     "query": ""}
        ...
        Log.error(f"Stats: {traceback.format_exc()}")
...
def test2(args):
    ...
    try:
        ...
        req_param = {"stats_id": 1, "metrics_list": metrics_list, "from_t": from_t, "to_t": to_t,
...
def test3(args):
    ...
    try:
        ...
        to_t = int(time.time())
        from_t = to_t - 30
        req_param = {"stats_id": 1, "panels_list": tp.get_panels(), "from_t": from_t, "to_t": to_t,
                     "interval": 10, "total_sample": "", "output_format": "gui"}
