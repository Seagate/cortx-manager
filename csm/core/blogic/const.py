...
METRICS_PERF_STATS_RETENTION_PERIOD = 'perf_stat_msg_retention_period'
METRICS_PERF_STATS_RETENTION_PERIOD_KEY = 'cortx>csm>metrics>stats>retention_period'
...
MSG_BUS_PERF_STAT_RETENTION_PERIOD = 'MESSAGEBUS>PRODUCER>STATS>perf>retention_period'
