...
RGW_JSON_ARGUMENTS = 'arguments'
LINK_BUCKET_OPERATION = 'link'
UNLINK_BUCKET_OPERATION = 'unlink'
SUPPORTED_BUCKET_OPERATIONS = [LINK_BUCKET_OPERATION, UNLINK_BUCKET_OPERATION]
