...
CSM_TLS_CERTIFICATE_BUNDLE_BASE = CONSUL_CONFIG_BASE + 'tls/'
CSM_TLS_CERTIFICATE_BUNDLE_RUNTIME_PATH = f'{CSM_PATH}/conf/etc/csm/tls.pem'
...
CSM_TLS_CERTIFICATE_BUNDLE_INDEX = 'CSM_TLS_BUNDLE'
...
SSL_PK_KEY = 'cortx>common>security>ssl_pk'
