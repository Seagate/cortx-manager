...
S3_IAM_ENDPOINTS_KEY = 'cortx>s3>iam>endpoints'
S3_DATA_ENDPOINTS_KEY = 'cortx>s3>data>endpoints'
S3_AUTH_ADMIN_KEY = 'cortx>s3>auth>admin'
S3_AUTH_SECRET_KEY = 'cortx>s3>auth>admin'
