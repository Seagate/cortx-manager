...
CSM_DEFAULT_CONF = "{}/conf/csm_default_config.yaml".format(CSM_PATH)
CSM_DEFAULT_DB = "{}/conf/csm_default_db.yaml".format(CSM_PATH)
...
CSM_DEFAULT_CONF_INDEX = 'CSMDEFAULT'
CSM_DEFAULT_DB_INDEX = 'CSMDBDEFAULT'
