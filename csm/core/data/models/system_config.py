...
class EmailConfig(Model):
    ...
    def update(self, new_values: dict):
        ...
        :param new_values: Dictionary containing email config payload
        """
    ...
    def get_target_emails(self):
        ...
        stripped = (x.strip() for x in self.email.split(','))  # pylint: disable=no-member
    ...
    def to_smtp_config(self) -> SmtpServerConfiguration:
        ...
        config.smtp_use_ssl = self.smtp_protocol.lower() in [  # pylint: disable=no-member
            EMAIL_CONFIG_SMTP_SSL_PROTOCOL, EMAIL_CONFIG_SMTP_TLS_PROTOCOL]
        config.smtp_use_starttls = (self.smtp_protocol.lower()   # pylint: disable=no-member
                                    == EMAIL_CONFIG_SMTP_STARTTLS_PROTOCOL)
...
class CertificateInstallationStatus(Enum):
    """Enum represents current installation status for certificate installation"""
...
class SecurityConfig(CsmModel):
    ...
    def is_pending_status(self) -> bool:
        ...
        return (self.installation_status == CertificateInstallationStatus.IN_PROGRESS.value
                or self.installation_status == CertificateInstallationStatus.UNKNOWN.value)
    ...
    def is_installed(self) -> bool:
        ...
        return self.installation_status == CertificateInstallationStatus.INSTALLED.value
    ...
    def is_failed(self) -> bool:
        ...
        return self.installation_status == CertificateInstallationStatus.FAILED.value

    @property
    def is_unknown(self) -> bool:
        """
        Check if certificate installation status is unknown

        :return: True if certificate installation status is unknown and False otherwise
        """

        return self.installation_status == CertificateInstallationStatus.UNKNOWN.value
    ...
    def is_not_installed(self) -> bool:
        ...
        return self.installation_status == CertificateInstallationStatus.NOT_INSTALLED.value
...
class SystemConfigSettings(CsmModel):
    ...
    async def update(self, new_values: dict):
        ...
        :param new_values: Dictionary containing system config payload
        """
...
class License(CsmModel):
    ...
    async def update(self, new_values: dict):
        ...
        :param new_values: Dictionary containing license key payload
        """
