...
if __name__ == '__main__':
    ...
    try:
        ...
        arg_parser.add_argument("-d", type=int, default=90, help="days to keep data")
        arg_parser.add_argument("-n", type=str, default="localhost:9200",
                                help="address:port of elasticsearch service")
        arg_parser.add_argument("-f", type=str, default="timestamp",
                                help="field of index of elasticsearch service")
        arg_parser.add_argument("-i", nargs='+', default=[], help="index of elasticsearch")
