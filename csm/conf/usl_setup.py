...
class PostInstallCmd(Cmd):
    ...
    def process(self):
        self.usl.validate_pkgs()
        self.usl._prepare_and_validate_confstore_keys("post_install")
        rc = self.usl.post_install()
        return rc
...
class PrepareCmd(Cmd):
    ...
    def process(self):
        ...
        self.usl._prepare_and_validate_confstore_keys("prepare")
        rc = self.usl.prepare()
        return rc
...
class ConfigCmd(Cmd):
    ...
    def process(self):
        # TODO: Add actions here
        self.usl._prepare_and_validate_confstore_keys("config")
        rc = self.usl.config()
        return rc
...
class TestCmd(Cmd):
    ...
    def process(self):
        # TODO: Add actions here
        rc = self.usl.test(self.test_plan)
        return rc
